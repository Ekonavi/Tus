...
export async function createAuthWithClock(
  secret: string,
  ...
  return {
    ...
    async validateCredentials(
      ...
      const expected = (await crypto.subtle.sign("HMAC", macKey, data)).slice(
        0,
...
export async function createAuth(
  ...
  return await createAuthWithClock(secret, maxAgeSeconds, () =>
